...
module.exports = function mycred(message) {
        ...
        try{
            ...
            const targetNameManual = parsemycred(message.content)
         ...
         return message.channel.send("Hey, make sure to write this : !ac mycred *[your github name]* If unsuccessful, try then with your discord or discourse name")
